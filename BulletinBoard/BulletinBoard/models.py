...
class CategoryModel(models.Model):
    ...
    >>> from BulletinBoard.models import CategoryModel
...
class Bulletin(models.Model):
    ...
    # this is One to Many field -> built-in users has its examples which are authors
...
class Comment(models.Model):
    ...
    username = models.ForeignKey(User, on_delete=models.CASCADE, null=True)  # Или заменить на CharField, если это возможно
    ...
    def get_absolute_url(self):
        return reverse('bulletin-detail', kwargs={'pk': self.bulletin.pk})  # Изменено на bulletin_detail
